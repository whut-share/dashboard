    ...
    <ReusableSidebar
      :nav="[
        [
          {
            title: 'Overview',
            to: '/dsh/products/overview',
            icon: 'solid-interface-layout',
...
import ReusableSidebar from "@/components/common/ReusableSidebar.vue";
import EventsSidebar from "@/components/products/EventsSidebar.vue";
</script>
